...
//
//   const respuestaBusquedaPais = Convert.toRespuestaBusquedaPais(json);
//
// These functions will throw an error if the JSON doesn't
// match the expected interface, even if the JSON is valid.

export interface RespuestaBusquedaPais {
    name:           string;
...
export class Convert {
    public static toRespuestaBusquedaPais(json: string): RespuestaBusquedaPais[] {
        return cast(JSON.parse(json), a(r("RespuestaBusquedaPais")));
    }

    public static respuestaBusquedaPaisToJson(value: RespuestaBusquedaPais[]): string {
        return JSON.stringify(uncast(value, a(r("RespuestaBusquedaPais"))), null, 2);
    }
}
